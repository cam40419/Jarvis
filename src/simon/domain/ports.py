...
class ConversationStore(TransactionStore, Protocol):
    def answer_runs(self, thread_id: UUID, offset: int, limit: int) -> Sequence[Run]: ...
...
class InteractionStore(TransactionStore, Protocol):
...
class ConnectedStore(TransactionStore, Protocol):
    def home_command(
    ...
    ) -> Sequence[HomeCommand]: ...
    def save_home_command(self, command: HomeCommand) -> None: ...
    def home_devices(self, household_id: UUID) -> Sequence[HomeDevice]: ...
...
class VoiceStore(TransactionStore, Protocol):
